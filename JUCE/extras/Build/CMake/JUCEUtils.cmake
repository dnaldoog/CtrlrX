...
function(_juce_add_au_resource_fork shared_code_target au_target)
    ...
    add_custom_command(OUTPUT "${au_rez_output}"
        COMMAND "${JUCE_XCRUN}" Rez
            ...
            -I "${juce_found_AudioUnit}/../CoreServices.framework/Versions/A/Frameworks/AE.framework/Versions/A/Headers/"
            -I "${juce_found_AudioUnit}/../CoreServices.framework/Versions/A/Headers"
            -I "${CMAKE_OSX_SYSROOT}/System/Library/Frameworks/AudioUnit.framework/Headers"
            -isysroot "${juce_found_AudioUnit}/../../../../" # was #{CMAKE_OSX_SYSROOT}
            "${au_rez_sources}"
            -useDF
            -o "${au_rez_output}"
