...
namespace BinaryData
{
    ...
    const int            FONT_Digit_ttfSize = 13112;
    ...
    const int            FONT_Electronic_Highway_Sign_ttfSize = 27108;
    ...
    const int            FONT_LCD_ttfSize = 26172;
    ...
    const int            CtrlrLuaMethodTemplates_xmlSize = 23293;
