...
class CtrlrApplication : public JUCEApplication {
	public:
		...
		void shutdown() {
			...
			// 1. Force JUCE to safely clear out any static default LookAndFeel tracking
			juce::LookAndFeel::setDefaultLookAndFeel(nullptr);

			// 2. Clear all internal modern singleton elements and window tracking objects
			juce::DeletedAtShutdown::deleteAll();

			// 3. Close out the central JUCE message pipeline cleanly
