...
// public LookAndFeel_V4 // Removed v5.6.34 to set lnf version independently
{
  public:
    ...
    JUCE_DECLARE_WEAK_REFERENCEABLE(
        CtrlrEditor) // Added v5.6.34. To replace masterReference.clear() on destruction
  ...
  private:
    ...
    // ScopedPointer<LookAndFeel> currentLookAndFeel; // Updated v5.6.34. ScopedPointed will handle
    ...
    shuts down: CtrlrEditor begins its implicit destructor phase. The ScopedPointer<LookAndFeel>
