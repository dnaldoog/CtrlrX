...
void CtrlrCombo::mouseDown (const MouseEvent& e)
{
    if (canPerformFuzzySearch())
    {
		...
		return; // Prevent passing click down to child combo
    }
...
bool CtrlrCombo::FuzzySearchPanel::keyPressed(const juce::KeyPress &key, juce::Component *) {
