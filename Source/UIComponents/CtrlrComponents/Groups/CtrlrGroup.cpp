...
void CtrlrGroup::paint(Graphics &g) {
	...
	gradientFromProperty(g, getBounds(), getObjectTree(), Ids::uiGroupOutlineGradientType, Ids::uiGroupOutlineColour1,
						 Ids::uiGroupOutlineColour2);
...
const String CtrlrGroup::getComponentText() { return (label->getText()); }

void CtrlrGroup::setComponentText(const String &componentText) { setProperty(Ids::uiGroupText, componentText, true); }

double CtrlrGroup::getComponentMaxValue() { return (1); }
