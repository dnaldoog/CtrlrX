...
class CtrlrGroup : public CtrlrComponent, public DragAndDropTarget, public CtrlrGrouppingComponent {
	public:
		...
		enum GradientType { None, Vertical, Horizontal, Radial };
		...
		void setOwned(CtrlrComponent *componentToOwn, const int subIndexInGroup = 0,
					  const bool shouldOwnThisComponent = true);
		...
		getLookAndFeelFromComponentProperty(const String &lookAndFeelComponentProperty); // Modern signature match
