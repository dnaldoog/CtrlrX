...
class CtrlrLCDLabel : public CtrlrComponent, public CtrlrPanel::Listener, public Label::Listener
{
public:
	//==============================================================================
...
juce_UseDebuggingNewOperator
	...
	//==============================================================================
	// Label* ctrlrLabel;
	std::unique_ptr<Label> ctrlrLabel; // Updated v5.6.34. Thanks to @dnaldoog
