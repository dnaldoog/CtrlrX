...
class CtrlrLabel : public CtrlrComponent, public CtrlrPanel::Listener, public Label::Listener
{
public:
	//==============================================================================
...
juce_UseDebuggingNewOperator
	...
	std::unique_ptr<CtrlrLabelInternal> ctrlrLabel; // Updated v5.6.34. Thanks to @dnaldoog
