...
CtrlrFixedImageSlider::CtrlrFixedImageSlider(CtrlrModulator& owner)
    : CtrlrComponent(owner), ctrlrSlider(0) {
...
Slider* CtrlrFixedImageSlider::getOwnedSlider() { return (ctrlrSlider); }
//[/MiscUserCode]
...
CtrlrFixedImageSlider::~CtrlrFixedImageSlider() { deleteAndZero(ctrlrSlider); }
...
LookAndFeel* CtrlrFixedImageSlider::getLookAndFeelFromComponentProperty(
