...
CtrlrSlider::CtrlrSlider(CtrlrModulator& owner)
    : CtrlrComponent(owner), lf(*this, componentTree), // Ensure this matches your 5.3 header
                                                       // variable name & constructor signature
      ctrlrSlider(*this) {
...
CtrlrSlider::~CtrlrSlider() { componentTree.removeListener(this); }
...
void CtrlrSlider::valueTreePropertyChanged(ValueTree& treeWhosePropertyHasChanged,
    ...
    if (property == Ids::uiSliderStyle) {
        ...
        ctrlrSlider.setColour(Slider::thumbColourId,
                              VAR2COLOUR(getProperty(Ids::uiSliderThumbColour)));
        ...
        ctrlrSlider.setColour(Slider::trackColourId,
                              VAR2COLOUR(getProperty(Ids::uiSliderTrackColour)));
...
CtrlrSlider::CtrlrSlider(CtrlrModulator& owner) : CtrlrComponent(owner), ctrlrSlider(*this) {
    ...
    if (editor != nullptr) {
        if (panelLnF == "V3") {
            ctrlrSlider.setLookAndFeel(editor->lfV3.get());
        } else if (panelLnF == "V2") {
            ctrlrSlider.setLookAndFeel(editor->lfV2.get());
        } else if (panelLnF == "V1") {
            ctrlrSlider.setLookAndFeel(editor->lfV1.get());
        }
        //   else if (panelLnF == "V4")  { ctrlrSlider.setLookAndFeel (editor->lfV4.get()); }
        else {
            ctrlrSlider.setLookAndFeel(nullptr);
        } // Defaults to internal V4
    } else {
        ctrlrSlider.setLookAndFeel(nullptr);
    }
    ...
    if (panelLnF == "V3" || panelLnF == "V2" || panelLnF == "V1") {
        ...
        setProperty(Ids::uiSliderRotaryFillColour,
                    (String)findColour(Slider::rotarySliderFillColourId).toString());
        setProperty(Ids::uiSliderThumbColour, (String)findColour(Slider::thumbColourId).toString());
        setProperty(Ids::uiSliderTrackColour,
                    (String)findColour(Slider::rotarySliderFillColourId).toString());
        setProperty(Ids::uiSliderLookAndFeelIsCustom, false);
    ...
    setProperty(Ids::uiSliderIncDecButtonColour,
                (String)findColour(Slider::backgroundColourId).toString());
...
void CtrlrSlider::resetLookAndFeelOverrides() {
    if (restoreStateInProgress == false) {
        ...
        setProperty(Ids::uiSliderIncDecTextColour,
                    (String)findColour(Slider::textBoxTextColourId).toString());
        setProperty(Ids::uiSliderIncDecButtonColour,
                    (String)findColour(Slider::backgroundColourId).toString());
