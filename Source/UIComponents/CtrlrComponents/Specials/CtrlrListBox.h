...
class CtrlrListBox : public CtrlrComponent, public ListBoxModel
{
public:
	//==============================================================================
...
juce_UseDebuggingNewOperator
	...
	std::unique_ptr<CtrlrValueMap>
		valueMap;
	WeakReference<CtrlrLuaMethod> itemClickedCbk, itemDoubleClickedCbk, itemDeleteKeyPressedCbk,
		itemReturnKeyPressedCbk;
	//[/UserVariables]
