...
/**
	...
	Describe your class and how it works here!
																	//[/Comments]
*/
class CtrlrLuaConsole : public CtrlrChildWindowContent, public CtrlrLog::Listener, public KeyListener {
	public:
		//==============================================================================
		...
		enum ToolbarItems { _none, snipsItem, historyItem, clearOutput };

		enum MoveDirection { NONE, UP, DOWN };
		...
		uint8 getType() {
			return (CtrlrPanelWindowManager::LuaConsole);
		}
