...
class CtrlrLuaMethodEditor : public CtrlrChildWindowContent,
  ...
  public:
    ...
    enum ToolbarItems { _none, saveMethod, saveAndCompileMethod, findInMethod };
    ...
    const bool
    isInterestedInDragSource(const ValueTree& item,
                             const DragAndDropTarget::SourceDetails& dragSourceDetails) const;
    void itemDropped(ValueTree& item, const DragAndDropTarget::SourceDetails& dragSourceDetails,
                     int insertIndex);
    ...
    void tabChanged(CtrlrLuaMethodCodeEditor* codeEditor, const bool save = false,
    ...
    void searchResultClicked(const String& methodName, const int lineNumber,
    ...
    GenericCodeEditorComponent* getEditorComponent() { return editorComponent; }
