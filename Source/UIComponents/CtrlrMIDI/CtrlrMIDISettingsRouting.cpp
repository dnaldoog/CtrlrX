...
//==============================================================================
CtrlrMIDISettingsRouting::CtrlrMIDISettingsRouting(CtrlrPanel &_owner) : owner(_owner) {
	//[Constructor_pre] You can add your own custom stuff here..
	//[/Constructor_pre]
	groupComponent = std::make_unique<GroupComponent>("new group", TRANS("THRU"));
	addAndMakeVisible(groupComponent.get());

	inDev2OutDev = std::make_unique<ToggleButton>("");
	addAndMakeVisible(inDev2OutDev.get());
	inDev2OutDev->setTooltip(TRANS(
		"All messages that are received on the MIDI Input device will be copied to the selected output MIDI Device"));
	inDev2OutDev->setButtonText(TRANS("IN Device  -> OUT Device"));
	inDev2OutDev->addListener(this);

	ctrlDev2OutDev = std::make_unique<ToggleButton>("");
	addAndMakeVisible(ctrlDev2OutDev.get());
	ctrlDev2OutDev->setTooltip(TRANS("All messages that are received on the MIDI Controller device will be copied to "
									 "the selected output MIDI Device"));
	...
	inDev2OutDevCh = std::make_unique<ToggleButton>("");
	addAndMakeVisible(inDev2OutDevCh.get());
...
void CtrlrMIDISettingsRouting::resized() {
	...
	groupComponent->setBounds(proportionOfWidth(0.0500f), proportionOfHeight(0.0200f), proportionOfWidth(0.9000f),
							  proportionOfHeight(0.9560f));
	inDev2OutDev->setBounds(proportionOfWidth(0.1000f), proportionOfHeight(0.2200f), proportionOfWidth(0.6000f),
							proportionOfHeight(0.1000f));
	ctrlDev2OutDev->setBounds(proportionOfWidth(0.1000f), proportionOfHeight(0.3680f), proportionOfWidth(0.6000f),
							  proportionOfHeight(0.1000f));
	host2OutDev->setBounds(proportionOfWidth(0.1000f), proportionOfHeight(0.5120f), proportionOfWidth(0.6000f),
						   proportionOfHeight(0.1000f));
	host2Host->setBounds(proportionOfWidth(0.1000f), proportionOfHeight(0.6560f), proportionOfWidth(0.6000f),
						 proportionOfHeight(0.1000f));
	inDev2OutDevCh->setBounds(proportionOfWidth(0.8000f), proportionOfHeight(0.2200f), 24, proportionOfHeight(0.1000f));
	ctrlDev2OutDevCh->setBounds(proportionOfWidth(0.8000f), proportionOfHeight(0.3680f), 24,
								proportionOfHeight(0.1000f));
	...
	label->setBounds(proportionOfWidth(0.7400f), proportionOfHeight(0.0800f), proportionOfWidth(0.1600f),
					 proportionOfHeight(0.1200f));
	inDev2Host->setBounds(proportionOfWidth(0.1000f), proportionOfHeight(0.8000f), proportionOfWidth(0.6000f),
						  proportionOfHeight(0.1000f));
