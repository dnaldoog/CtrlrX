...
class CtrlrPopupMenuLook : public LookAndFeel_V4 {
	public:
		...
		void drawPopupMenuItem(Graphics &g, int width, int height, bool isSeparator, bool isActive, bool isHighlighted,
	...
	public:
		...
		enum EditMenuItems {
			...
			DistributeHorizontally =
				2061, // Added v5.6.36. Thanks to @dnaldoog. Align/Resize to first selection between components
		...
		CtrlrComponent *addNewComponent(const Identifier &componentType, const Point<int> insertAt,
										Component *componentToAddTo = 0);
		CtrlrComponent *addNewComponent(const Identifier &componentType, const Rectangle<int> componentBounds);
		CtrlrComponent *addNewComponent(const ValueTree &savedState, Component *componentToAddTo = 0,
		...
		void fitSelection();
		ResizableBorderComponent *getResizableBorder() {
			return (ctrlrPanelCanvasResizableBorder);
		}
		...
		int getNumLayers();
		void addAndMakeVisibleNg(CtrlrComponent *componentToAdd, Component *componentToAddTo = 0,
								 const bool force = false);
